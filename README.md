...
This repository contains my complete Windows 11 power-user setup.

It combines:

- GlazeWM tiling window manager
- YASB status bar
- Flow Launcher productivity workflow
...
**Create a fast, keyboard-first Windows experience that feels closer to Linux power-user workflows while keeping full Windows compatibility.**

Whether you're a developer, student, sysadmin, gamer, or productivity enthusiast, this repo provides configs, tools, themes, and recommendations to build a highly optimized Windows workstation.
...
✅ Linux-inspired desktop experience
